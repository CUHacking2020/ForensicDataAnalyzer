...
class GUI:
    ...
    def suspects_window(self):
        ...
        sus2 = Button(window,text="  Jason\n  Hotel Guest\n  (Suspect #1)", height = 200, width = 300, image = img2, compound = "left",
        ...
        sus3 = Button(window,text="  Thomas\n  Hotel Guest\n   (Suspect #3)", height = 200, width = 300, image = img3, compound = "left",
        ...
        sus4 = Button(window,text="  Rob\n  Hotel Guest\n   (Suspect #5)", height = 200, width = 300, image = img4, compound = "left",
        ...
        sus5 = Button(window,text="  Kristina\n  Hotel Guest\n   (Suspect #4)", height = 200, width = 300, image = img5, compound = "left",
        ...
        sus6 = Button(window,text="  Marc-Andre\n  Hotel Staff\n   (Suspect #2)", height = 200, width = 300, image = img6, compound = "left",
        ...
        sus7 = Button(window,text="  Dave\n  Hotel Staff\n   (Suspect #6)", height = 200, width = 300, image = img7, compound = "left",
        ...
        sus8 = Button(window,text="  Salina\n  Hotel Staff\n   (Suspect #10)", height = 200, width = 300, image = img8, compound = "left",
        ...
        sus9 = Button(window,text="  Harrison\n  Hotel Staff\n   (Suspect #11)", height = 200, width = 300, image = img9, compound = "left",
        ...
        sus10 = Button(window,text="  Eugene\n  Non-Guest\n   (Suspect #9)", height = 200, width = 300, image = img10, compound = "left",
        ...
        sus11 = Button(window,text="  Alok\n  Non-Guest\n   (Suspect #7)", height = 200, width = 300, image = img11, compound = "left",
        ...
        sus12 = Button(window,text="  James\n  Non-Guest\n   (Suspect #8)", height = 200, width = 300, image = img12, compound = "left",
